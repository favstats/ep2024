...
hcmap(
  map = "custom/europe",
  data = ncavc %>% mutate(spn_per_capita = log(spn_per_capita)), 
...
hc_tooltip(formatter = JS("function () {
  ...
  hc_title(text = glue::glue("Political Ad Spend on Facebook and Instagram in last 30 Days ({last30days_string})")) %>%
